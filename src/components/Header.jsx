    ...
    <div className='sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-black'>
      {loading && <Loader/>}
        ...
        <div className='flex h-5 items-center'>
          ...
          <img className='h-full md:hidden' src={ytLogoMobile} alt="YouTube"/></Link>
          
        </div>
        <div className='group flex items-center'> 
                <div className='flex  h-8 ml-2 md:h-10 md:ml-10 md:pl-5 border border-[#303030] rounded-l-3xl group-focus-within:border-blue-500 md:group-focus-within:ml-5 md:group-focus-within:pl-0'>
                  <div className='w-10 items-center justify-center hidden group-focus-within:md:flex'>
                    <IoIosSearch className='text-white text-xl'/>

                  </div>
                  <input type='text' className='bg-transparent outline-none text-white pr-5 pl-5 w-44 md:pl-0 md:group-focus-within:pl-0 md:w-60 lg:w-[500px]'
          ...
          <div className='flex items-center'>
              ...
              <div className='flex h-8 w-8 overflow-hidden rounded-full ml-2 md:ml-4'>
